							...
							Object.entries(providers || {}).flatMap(([provider, pv]) =>
								Object.entries(pv.models).map(([model, ms]) => {
									...
									return react.createElement(
										...
										[
											react.createElement("td", { key: "p", style: { ...tdStyle, color: STYLE.labelSecondary }, title: provider }, provider),
											react.createElement("td", { key: "m", style: { ...tdStyle, fontWeight: 650 }, title: model }, model),
											react.createElement("td", { key: "b", style: tdNum }, fmt(billed)),
											react.createElement("td", { key: "i", style: tdNum }, fmt(ms.inputTokens)),
											react.createElement("td", { key: "cr", style: tdNum }, fmt(ms.cacheReadTokens)),
											react.createElement("td", { key: "o", style: tdNum }, fmt(ms.outputTokens)),
							...
							? [
								...
								react.createElement(
									...
									react.createElement("div", { key: "chart", className: "dts-chart" }, chartDays.map((d, i) =>
										react.createElement("div", { key: d.day, className: "dts-chart-day", title: `${d.day}\n计费输入 ${fmt(d.input)}\n输出 ${fmt(d.output)}` }, [
											react.createElement("div", { key: "bars", className: "dts-chart-bars" }, [
												react.createElement("div", { key: "in", className: "dts-chart-bar", style: { height: Math.max(2, Math.round((d.input / chartMax) * BAR_H)), background: STYLE.accent, opacity: i === chartDays.length - 1 ? 1 : .88 } }),
												react.createElement("div", { key: "out", className: "dts-chart-bar", style: { height: Math.max(2, Math.round((d.output / chartMax) * BAR_H)), background: STYLE.labelTertiary, opacity: .55 } })
										]),
