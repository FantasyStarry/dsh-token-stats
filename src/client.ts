...
`;
											...
											? react.createElement(
													...
													[
														...
														react.createElement(
															...
															`${total.reasoningTokens > 0 ? `推理 ${fmtCompact(total.reasoningTokens)} · ` : ""}平均输入 ${fmtCompact(billedTotal / Math.max(1, total.requests))}/请求`
														),
														react.createElement(
															"div",
		 ...
		 */
		const stUseMonth = (): { month: HistoryData | null; load: () => void; loading: boolean } => {
									...
									list.map((s) => {
										...
										return react.createElement(
											...
											[
												react.createElement(
													"td",
													{ key: "id", className: "dts-cell-ellipsis", style: { ...tdStyle, ...NUM, maxWidth: 160, overflow: "hidden", textOverflow: "ellipsis" }, title: s.id },
													[
							...
							[
								react.createElement(
									...
									react.createElement(
										"tr",
										null,
										["日期", "计费输入", "缓存读", "输出", "请求"].map((h, i) => react.createElement("th", { key: h, style: i === 0 ? thLeft : thStyle }, h))
									)
								),
								react.createElement(
									"tbody",
						...
						[
							...
							react.createElement(
								...
								[
									...
									react.createElement(
										"button",
										{ key: "refresh", type: "button", onClick: reload, className: "dts-refresh", title: "刷新统计", "aria-label": "刷新统计" },
										"↻"
									),
									lastUpdated
