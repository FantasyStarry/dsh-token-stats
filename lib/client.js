...
`;
        ...
        function SlimeSvg(props) {
            ...
            return react.createElement("svg", {
                ...
                react.createElement("g", { key: "sprout", className: "ts-pet-sprout" }, [
                        ...
                        error
                            ...
                            : total
                                ? react.createElement("div", { key: "body" }, [
                                    ...
                                    react.createElement("div", { key: "meta", style: { marginTop: 8, fontSize: 11.5, color: STYLE.labelTertiary } }, `缓存命中率 ${hitRate.toFixed(0)}%${total.reasoningTokens > 0 ? ` · 推理 ${fmtCompact(total.reasoningTokens)}` : ""}`),
                                    chartDays.length > 0
                                        ...
                                        : null,
                                    react.createElement("div", { key: "cap", style: { marginTop: 12, fontSize: 11, color: STYLE.labelTertiary } }, "完整明细见 设置 → 用量统计")
                                ])
